    ...
    <header className="relative z-50 flex-none lg:pt-11">
      ...
      <div className='px-0 mx-auto sm:px-4 lg:px-8'>
        <nav className='flex items-center justify-center mt-6' mt-6 aria-label="Site">
          <ul className="flex items-center justify-center gap-8 px-8 py-4 overflow-x-auto text-lg leading-tight text-center text-blue-600 bg-blue-100 border-b sm:rounded-full border-blue-900/10 sm:-mx-6 lg:mx-0 lg:justify-start">
