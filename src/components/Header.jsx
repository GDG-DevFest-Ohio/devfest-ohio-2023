  ...
  return (
    <header className="relative z-50 flex-none lg:pt-11">
      <Container className="flex flex-wrap items-center justify-center sm:justify-between lg:flex-nowrap">
        ...
        <div className="whitespace-wrap order-first -mx-4 flex flex-auto basis-full overflow-x-auto border-b border-blue-600/10 py-4 font-mono text-xl font-semibold text-blue-600 sm:-mx-6 lg:order-none lg:mx-0 lg:basis-auto lg:border-0 lg:py-0">
          <div className="mx-auto flex items-center gap-4 px-4">
            <p className="whitespace-nowrap">
              <time dateTime="2023-11-11">11</time>-
              <time dateTime="2023-11-12">12 of November 2023</time>
            </p>
            <DiamondIcon className="hidden h-1.5 w-1.5 fill-current stroke-current sm:overflow-visible" />
            <p className="whitespace-nowrap">
